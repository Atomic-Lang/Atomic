...
#ifndef ATOMIC_COFF_EMITTER_HPP
#define ATOMIC_COFF_EMITTER_HPP
...
// Flag interna: IDs com esse bit sao referencias a secoes, nao a user symbols
constexpr uint32_t SECTION_SYM_FLAG = 0x80000000;

// ============================================================================
// ESTRUTURAS COFF (layout binario exato)
// ============================================================================
...
public:
    ...
    // Retorna ID para usar em relocacoes que referenciam uma secao
    ...
    bool write(const std::string& path) {
        ...
        // 1) Section symbols (cada secao = 1 symbol + 1 aux = 2 entradas)
